...
#getting an unpack error for this function

act_map_deep5_2, act_map_deep5_1, act_map_deep_6, act_map_deep56_AR1_1, act_map_deep56_AR1_2, act_map_deep56_AR2_1, act_map_deep56_AR2_2= ACT_crop(act_map_deep56_AR2_1, act_map_deep56_AR2_2, act_map_deep56_AR1_1, act_map_deep56_AR1_2, act_map_deep5_1, act_map_deep5_2, act_map_deep_6, unpack = True)
'''
...
#cluster_RA, cluster_Dec, cluster_r_eff, cluster_ID, cluster_e_f = np.loadtxt('cluster_skypos.txt', unpack=True)
...
for j in np.arange(0,len(void_RA)):
    ...
    if mod_smaps == []:
        ...
        print "The standard deviation of the temperature for this bin is", np.std(del_T_list)
